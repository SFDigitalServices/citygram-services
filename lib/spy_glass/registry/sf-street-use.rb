      ...
      'properties' => {
        ...
        'type' => {
          ...
          'subtype' => {
            ...
            'description' => permit_type_metadata[permit_type] && permit_type_metadata[permit_type]["description"],
            'link' => permit_type_metadata[permit_type] && permit_type_metadata[permit_type]["link"],
          }
        },
